...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SlicingSekeltalMesh")
	static void SliceProceduralMesh(UProceduralMeshComponent* InProcMesh, FVector PlanePosition, FVector PlaneNormal,
		bool bCreateOtherHalf, UProceduralMeshComponent*& OutOtherHalfProcMesh, EProcMeshSliceCapOption CapOption,
		UMaterialInterface* CapMaterial, TMap<int32, int32>& OutSlicedToBaseVertexIndex,
